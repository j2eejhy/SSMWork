...
public class Page<E> implements Serializable {
	...
	/**
	 * 是否已用其它方式获取总记录数，如果已获取，则不执行countSql
	 */
	private boolean alreadyHaveTotalRecord=false;
	...
	* @param value void    返回类型  
	...
	public String toString() {
		return "Page{" +
				...
				", alreadyHaveTotalRecord=" + alreadyHaveTotalRecord +
				", haveCountSql=" + haveCountSql +
				", params=" + params +
				'}';
	}
	...
	public boolean isAlreadyHaveTotalRecord() {
		return alreadyHaveTotalRecord;
	}

	public void setAlreadyHaveTotalRecord(boolean alreadyHaveTotalRecord) {
		this.alreadyHaveTotalRecord = alreadyHaveTotalRecord;
	}
