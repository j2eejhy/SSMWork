...
public class SFTPUtil {
    ...
    public static void main(String[] args) throws SftpException, IOException {
        ...
        sftp.login();
       /* File file = new File("C:\\Users\\admin\\Desktop\\视图 - 副本.exe");
        String fileName = file.getName();
        InputStream is = new FileInputStream(file);

        sftp.upload("/usr","upload", fileName, is);

        sftp.download("/usr/upload" ,"视图 - 副本.exe","D:/java");*/

       sftp.delete("/usr/upload" ,"视图 - 副本.exe");
        sftp.logout();
    }
